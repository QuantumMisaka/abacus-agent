...
def run_phono3py_thermal(
    *,
    ...
    return {"work_dir": str(root), "kappa_hdf5": str(kappa_path) if kappa_path.is_file() else None, "gamma_hdf5": str(gamma_path) if gamma_path.is_file() else None, "runtime": contract, "options": options}
